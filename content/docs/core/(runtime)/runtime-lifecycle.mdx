...
See the [runtime source and tests](https://github.com/LioRael/lenso/tree/main/crates)
for current implementation evidence; an accepted profile is not proof that every
Adapter has released it.
