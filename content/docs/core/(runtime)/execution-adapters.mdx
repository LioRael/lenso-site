...
| --- | --- |
| Tokio Runner, native Adapter, browser and WASIp2 Drivers | `LioRael/lenso` |
| Bun child-process Adapter and prepared Host runtime | `LioRael/lenso` |
| Bun SDK and TypeScript Host authoring | `LioRael/lenso-js` |
| Descriptor code generation and portable value conformance | `LioRael/lenso` |
...
[Bun Plugin authoring](/docs/core/bun-plugin-authoring) for the complete scaffold and
development path.
