...
To add pages to your own application, start with [App Console](/docs/core/app-console), which needs no Agent. The Agent-oriented local workspace below is a separate launch path.
