...
<CardGroup>
  ...
  <Card title="Launch and inspect Console" href="/docs/core/console" description="Launch the local Console, distinguish App and Console Agent identities, and inspect the selected App's Plugin Root." />
  <Card title="Open Projects" href="/docs/core/projects" description="Select an authorized workspace and understand the Provider-owned project, issue, and catalog boundary." />
  <Card title="Run one durable Job" href="/docs/core/jobs" description="Trace enqueue, claim, lease recovery, completion, failure, retry, and inspection for one single-step Job." />
