...
wire. The response for the request above is `HELLO`. Watch mode stays alive
...
See [`@lenso/bun`](https://www.npmjs.com/package/@lenso/bun) and the
[`lenso-js` source](https://github.com/LioRael/lenso-js/tree/main/packages/lenso-bun-plugin)
for the typed SDK, and the
[`lenso` Adapter](https://github.com/LioRael/lenso/tree/main/crates/lenso-bun-adapter)
...
See the [Bun SDK](https://github.com/LioRael/lenso-js/tree/main/packages/lenso-bun-plugin)
