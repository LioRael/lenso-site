...
It turns an application's Plugins, Capability bindings, execution choices, and
...
<CardGroup>
  <Card title="Quickstart" href="/docs/quickstart" description="Install the CLI, scaffold a typed Bun Plugin, and run its production Adapter development loop." />
  <Card title="Agent skills" href="/docs/agent-skills" description="Install the six public workflows, route work to the right owner, and ask for verifiable completion evidence." />
  ...
  <Card title="Rust Plugins" href="/docs/plugin-authoring" description="Implement a generated Provider and register its native factory." />
