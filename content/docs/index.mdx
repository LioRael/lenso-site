...
<CardGroup>
  <Card title="Quickstart" href="/docs/quickstart" description="Install the CLI, scaffold a typed Bun Module, and run its production Adapter development loop." />
  ...
  <Card title="Bun Modules" href="/docs/bun-module-authoring" description="Generate a complete typed project and develop it with fresh Plans and hot reload." />
