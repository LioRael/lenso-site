...
<CardGroup>
  ...
  <Card title="Work with an agent" href="/agent-skills" description="Connect the docs MCP server, install the Lenso skills, and give a coding agent a checkable outcome." />
...
`https://lenso.dev/agent-readability.json`, and a read-only MCP server at
`https://lenso.dev/mcp`.
