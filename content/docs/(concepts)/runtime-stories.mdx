...
A Runtime Story makes those answers visible in Lenso Console.
...
Lenso Console reads those records through `/admin/runtime/stories` and
renders:
...
Lenso Console calls the host-owned runtime APIs:
