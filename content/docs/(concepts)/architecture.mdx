...
description: The stable seams between composition, portable Kernel mechanisms, host scheduling, and Module execution.
---
...
The owner of Module generation and endpoint mechanics: native factories, Bun
...
Modules removes their complexity.

## Dependency direction

```text
product Modules / authoring / examples
                 ↓
...
Core never depends back on a concrete Driver, Adapter, Module, CLI, or example.
