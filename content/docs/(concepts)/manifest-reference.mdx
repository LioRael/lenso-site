...
events, lifecycle work, Console packages, dependencies, and capabilities.
...
| `runtime` | Runtime function declarations. The declaration is manifest data; handlers live in the loading source. |
...
- a new runtime function or event handler;
