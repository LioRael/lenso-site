...
description: Expose module data, actions, queries, and custom operator views through Lenso Console.
---

Admin surfaces are how a module becomes operable. They describe the data,
actions, and read-only values that Lenso Console can show without importing
module internals.
...
Lenso Console reads the records through host-owned `/admin/data/*` endpoints.
