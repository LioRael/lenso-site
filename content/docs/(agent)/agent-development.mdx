...
| Build an out-of-process service module | `lenso-service-module-authoring` | `lenso service create <name> --lang ts` |
...
```text
lenso-business-planning -> lenso-start -> lenso app compose -> lenso agent task --from-app-plan -> checks -> the Console Service root URL
```
