...
```text
lenso capability init -> lenso capability check -> lenso app compose --pack -> lenso agent task --for-capability -> checks -> /console
```
...
| Capability pack | `lenso capability check <pack-dir>` plus Launchpad App Change Plan evidence |
