...
login, Lenso Console access, or both.
...
Lenso Console extension registry. Restart the API and worker after installing
or updating modules.
...
- the configured Console Service URL lists `auth` under Modules.
