---
title: Observability
description: Use health probes, structured logs, OTLP traces, and Lenso Console runtime views.
---

Lenso has two observability layers:

- process-level health, logs, and traces for operators;
- Lenso Console views backed by platform/runtime tables for module activity.
...
line and search Lenso Console story/technical-operation views with that id.
...
the same Lenso Console views as other background work.

## What to log from modules

Use structured fields that connect logs to Lenso Console evidence:
