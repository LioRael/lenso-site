...
A production cloud provider belongs in its own Module. It implements the
...
allow cross-lane transfer. The maintained Env provider is a linked Rust Module.
A Bun Module cannot consume it across a process lane merely because TypeScript
