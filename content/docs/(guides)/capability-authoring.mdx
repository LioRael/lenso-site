...
For a new Request Capability and Bun Provider, `lenso module create NAME
--runtime bun` generates the Descriptor, schemas, both bindings, and the typed
...
Generated TypeScript imports `@lenso/contract-runtime`. A Bun Module scaffold
installs it through `@lenso/bun-module`; a standalone contract package can add
it directly:
