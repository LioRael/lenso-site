...
Keep SQL in the owning Module's `migrations/` directory. Rust retains only the
...
Append a new SQL file and declaration without editing an applied file. The new Module generation first
