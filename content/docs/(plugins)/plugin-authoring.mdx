...
Add the resulting Bundle through [Add Plugins to an App](/docs/plugin-composition).
For another Capability role, define its contract first and use the
[Linked Rust Plugin](/docs/linked-rust-plugin) path or a supported typed SDK.
