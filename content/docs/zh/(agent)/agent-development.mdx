...
|构建进程外服务模块 | `lenso-service-module-authoring` | `lenso service create <name> --lang ts` |
...
```text
lenso-business-planning -> lenso-start -> lenso app compose -> lenso agent task --from-app-plan -> checks -> Console Service 根地址
```
