...
<CardGroup>
  ...
  <Card title="Rust Module" href="/docs/zh/module-authoring" description="实现生成的 Provider，并注册原生 Factory。" />
  <Card title="Bun Module" href="/docs/zh/bun-module-authoring" description="通过 Bun 进程 Adapter 构建并运行 TypeScript Provider。" />
  <Card title="Web Capabilities" href="/docs/zh/web-capabilities" description="发布 HTTP endpoint，并调用受策略约束的上游服务。" />
  <Card title="Auth Module" href="/docs/zh/auth-module" description="认证 Evidence、传递 Assertion，并在目标边界授权。" />
