...
<CardGroup>
  <Card title="快速开始" href="/docs/zh/quickstart" description="安装 CLI，创建强类型 Bun Module，并启动正式 Adapter 开发循环。" />
  ...
  <Card title="Bun Module" href="/docs/zh/bun-module-authoring" description="生成完整类型化项目，并通过 Fresh Plan 与热重载持续开发。" />
