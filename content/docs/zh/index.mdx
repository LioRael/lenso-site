...
<CardGroup>
  ...
  <Card title="与 Agent 协作" href="/docs/zh/agent-skills" description="连接文档 MCP、安装 Lenso Skills，并给 Coding Agent 一个可检查结果。" />
...
`https://lenso.dev/llms.txt`、`https://lenso.dev/agent-readability.json`，以及
`https://lenso.dev/mcp` 上的只读 MCP server。
