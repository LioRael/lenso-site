...
<CardGroup>
  <Card title="创建第一个 Plugin" href="/docs/zh/core/quickstart" description="安装 CLI，运行一个类型化 Plugin，并验证可分发 Bundle。" />
  <Card title="选择受支持的工作流" href="/docs/zh/core/supported-workflows" description="为产品与运行环境找到持续维护的 Authoring 和 Runtime 路径。" />
</CardGroup>
...
通过[受支持的工作流](/docs/zh/core/supported-workflows)选择 Authoring 与 Runtime
路径，并确认对应的平台、Auth 与隔离边界。
...
<CardGroup>
  ...
  <Card title="启动并检查 Console" href="/docs/zh/core/console" description="启动本地 Console，区分 App Agent 与 Console Agent 身份，并检查 Selected App 的 Plugin Root。" />
  <Card title="打开 Projects" href="/docs/zh/core/projects" description="选择有授权的 Workspace，理解由 Provider 持有的 Project、Issue 与 Catalog 边界。" />
  <Card title="运行一个 Durable Job" href="/docs/zh/core/jobs" description="跟踪一个单步 Job 的 Enqueue、Claim、Lease Recovery、Complete、Fail、Retry 与 Inspect。" />
