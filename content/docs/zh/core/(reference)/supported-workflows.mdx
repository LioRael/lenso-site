...
新增本地实现：[Engine 与源码 App](/docs/zh/core/engine-dx)、[可选 convention](/docs/zh/core/file-conventions)、[App Console](/docs/zh/core/app-console)。这些路径与已发布工具分开标注；下面的历史 Host 验证记录不代表新 Engine 路径仍有相同问题。
...
Replica、敌对浏览器代码隔离或托管的跨 App Console 产品。这些是明确的产品边界，不是使用上述工作流
之前还要等待通过的内部关卡。
