...
最新本地技能增加了 source App、可选 convention、App Console 和 Capability 自动生成分支。见[本地 DX](/docs/zh/core/engine-dx)与[文件 convention](/docs/zh/core/file-conventions)。发布前，远程安装命令不会获得这些本地修改；使用已更新的本地技能包。
