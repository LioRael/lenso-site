...
可直接参考持续维护的 [Request fixture](https://github.com/LioRael/lenso/tree/main/crates/lenso-contract-codegen/tests/fixtures/wit)。
...
和 [Event fixture](https://github.com/LioRael/lenso/tree/main/crates/lenso-contract-codegen/tests/fixtures/event)
也可参考。
