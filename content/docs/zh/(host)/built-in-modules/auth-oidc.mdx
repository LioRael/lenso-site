---
title: auth-oidc
description: 让Lenso Console通过 OIDC 使用主机的身份验证会话。
---

当生产Lenso Console用户应使用登录时安装 `auth-oidc`
...
Bearer Token融入其中。在生产中，配置的 Console Service URL 应该依赖密码
